...
echo ""
echo "=== Recommendation API Tests ==="
test_endpoint "Web Server Recommendation" "http://$WEB_IP:8080/recommendation" "200"
test_endpoint "API Server Recommendation" "http://$API_IP:8080/recommendation" "200"
test_endpoint "Compute Worker Recommendation" "http://$COMPUTE_IP:8080/recommendation" "200"
...
echo ""
echo ""
echo "Sample Recommendation (Web Server):"
curl -s "http://$WEB_IP:8080/recommendation" | jq '.' 2>/dev/null || curl -s "http://$WEB_IP:8080/recommendation"
